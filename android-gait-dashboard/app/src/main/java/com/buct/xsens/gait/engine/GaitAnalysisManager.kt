...
class GaitAnalysisManager(private val context: Context) {
    ...
    fun analyzeGait(filePath: String, weightStr: String): String {
        return analyzeGait(filePath, weightStr, "-1.0", "-1.0", "-1", "1")
    }

    @JavascriptInterface
    fun analyzeGait(filePath: String, weightStr: String, startTimeStr: String, endTimeStr: String): String {
        return analyzeGait(filePath, weightStr, startTimeStr, endTimeStr, "-1", "1")
    }
    ...
    fun analyzeGait(
        ...
        return analyzeGait(filePath, weightStr, startTimeStr, endTimeStr, takeoffStepStr, "1")
    }
    ...
    fun analyzeGait(
        ...
        val isTakeoffFoot = takeoffFootStr != "0" && takeoffFootStr.lowercase() != "false"

        android.util.Log.d(
            "GaitAnalysis",
            "Analyzing file: $filePath, weight: $weight, start: $startTimeS, end: $endTimeS, " +
                "takeoffStep: $takeoffStep, isTakeoffFoot: $isTakeoffFoot",
        )
        return try {
    ...
    fun analyzeGaitContent(content: String, weightStr: String): String {
        return analyzeGaitContent(content, weightStr, "-1.0", "-1.0", "-1", "1")
    }

    @JavascriptInterface
    fun analyzeGaitContent(content: String, weightStr: String, startTimeStr: String, endTimeStr: String): String {
        return analyzeGaitContent(content, weightStr, startTimeStr, endTimeStr, "-1", "1")
    }
    ...
    fun analyzeGaitContent(
        ...
        return analyzeGaitContent(content, weightStr, startTimeStr, endTimeStr, takeoffStepStr, "1")
    }
    ...
    fun analyzeGaitContent(
        ...
        return try {
            ...
            analyzeGait(tempFile.absolutePath, weightStr, startTimeStr, endTimeStr, takeoffStepStr, takeoffFootStr)
        } catch (e: Exception) {
